...
import com.geektime.flink.vo.OrderEvent;
import com.geektime.flink.vo.OrderResult;
...
public class OrderMonitor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<OrderEvent> orderEventStream = env.readTextFile("datas/OrderLog.csv")
                .map(line -> {
